	  ...
	  <div className={styles.wrapper}>
				...
				<div className={styles.head_contain}>
					<div className={styles.head_row}>
						<a href="#"><img className={styles.head_logo} src="src/assets/logo.png" alt="logo-store-online" /></a>
			...
			<div className={isStyledI
			  ? styles.head_sort + ' '+styles.head_sort_active
			  : styles.head_sort}>
			  <a href="#"
			...
			<textarea maxLength={100} onChange={(e)=> setInfo(e.target.value)}  value ={info} className={styles.input_four} placeholder='About product' />
